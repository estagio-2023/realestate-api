...
namespace EntityFrameworkApiLibrary.Migrations
{
    ...
    [Migration("20240627134502_AddRealEstateHasAmenitiesRealEstateRelationship")]
    partial class AddRealEstateHasAmenitiesRealEstateRelationship
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EntityFrameworkApiLibrary.Entity.Customer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("EntityFrameworkApiLibrary.Entity.RealEstateHasAmenities", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("EntityFrameworkApiLibrary.Entity.RealEstate", b =>
                {
                    ...
                    b.HasOne("EntityFrameworkApiLibrary.Entity.Customer", "Customer")
                        .WithMany("RealEstates")
                    ...
                    b.HasOne("EntityFrameworkApiLibrary.Entity.RealEstateType", "RealEstateType")
                        .WithMany("RealEstates")
                    ...
                    b.HasOne("EntityFrameworkApiLibrary.Entity.Typology", "Typology")
                        .WithMany("RealEstates")
            ...
            modelBuilder.Entity("EntityFrameworkApiLibrary.Entity.RealEstateHasAmenities", b =>
                {
                    b.HasOne("EntityFrameworkApiLibrary.Entity.Amenities", "Amenities")
                    ...
                    b.HasOne("EntityFrameworkApiLibrary.Entity.RealEstate", "RealEstate")
                        .WithMany("RealEstateHasAmenities")
